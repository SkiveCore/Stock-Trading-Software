...
$sql = "(SELECT 'bank' as type, transaction_type, amount, bank_method_id as method_id, transaction_date FROM user_bank_transactions WHERE user_id = ?)
        UNION ALL
        (SELECT 'stock' as type, transaction_type, quantity * price_per_share as amount, stock_id as method_id, transaction_date FROM user_stock_transactions WHERE user_id = ?)
